...
This project demonstrates how a scalable and highly available web application can be designed on AWS using a secure 3-tier architecture.
...
Project screenshots will be added during the implementation phase.
